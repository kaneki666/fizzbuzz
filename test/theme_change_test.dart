...
void main() {
  group('Theme Provider group ', () {
    ...
    test('Sharepreference saving theme test', () async {
      bool prefDarktheme = await themeprovider!.fizzBuzzPreferences.getTheme();

      expect(prefDarktheme, true);
    });

    test('Start animation test', () {
